...
{
	public static List<DogModel> dogs = new List<DogModel>
	{
	...
	{
		List<DogModel> sortetDogs = dogs.OrderBy(d => d.Name).ToList();

		// Visa en view med alla dogs
		return View(sortetDogs);

	}

	public IActionResult Details(int id)
	{
		// hämta hunden med specifikt Id
		DogModel? selectedDog = dogs.FirstOrDefault(d => d.Id == id);

		// skicka den till Viewen.
	...
	public IActionResult Adopt(int id)
	{
		...
		// Gör så att selectedDog blir true.
		if (selectedDog != null)
		{
